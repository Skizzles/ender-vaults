package com.github.dig.endervaults.nms.v1_20_R1;
...
public class v1_20_R1NMS implements VaultNMS {
    ...
    public String encode(Object[] craftItemStacks) throws IllegalAccessException, InstantiationException, InvocationTargetException, NoSuchMethodException {
        ...
        Object nbtTagList = nbtTagListClass.getConstructor().newInstance();
        ...
        for (final Object craftItemStack : craftItemStacks) {
